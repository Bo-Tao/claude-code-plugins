...
| [`botao`](plugins/botao) | 手写的 Agent Skills 与斜杠命令 —— `commit`、`mr`、`/version` |
...
`/botao:version 20260915 …` 声明本次会话的版本日期，`rename-session` 会把它变成 `V20260915｜` 的标题前缀。

→ [skill 与命令清单，以及如何新增一个](plugins/botao/README.md)
