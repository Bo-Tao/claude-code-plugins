...
```
/plugin install caffeinate@claude-plugins-botao
```

### Manual Installation

```bash
git clone https://github.com/Bo-Tao/claude-plugins-botao.git
claude --plugin-dir ./claude-plugins-botao/plugins/caffeinate
```
